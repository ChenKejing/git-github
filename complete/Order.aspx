<%@ Page Language="VB" MasterPageFile="~/PPQ.master" AutoEventWireup="false" CodeFile="Order.aspx.vb" Inherits="Order" title="Untitled Page" %>
    ...
    <asp:DataList ID="DataList1" runat="server" CellPadding="4" ForeColor="#333333">
        ...
        <ItemTemplate>
            ...
            <asp:Repeater ID="Repeater1" runat="server"
                DataSource='<%# CType(Container.DataItem, DataRowView).CreateChildView("MenuLink") %>' OnItemCommand="Repeater1_ItemCommand"
                >
                <ItemTemplate>
                    <span style="color: Firebrick;">
                        <asp:LinkButton ID="OrderItem" runat="server" ToolTip="Add item to order"  style="text-decoration:none;"
                            CommandName='<%# Eval("ItemSize") %>' CommandArgument='<%# Eval("ItemPrice") %>'>
                            <asp:Image ID="Image1" runat="server"
                                ImageUrl="~/images/cartIcon.gif" AlternateText="Add item to order button" />

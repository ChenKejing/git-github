...
Partial Class Checkout
    ...
    Protected Sub DropDownList1_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        ' update the details view, which pushes the values back into the object (cart)
        FormView1.UpdateItem(False)

    End Sub

    Protected Sub ObjectDataSource1_Updating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ObjectDataSourceMethodEventArgs)

        ' the data source is updating, so add the parameter in

...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <br />
   Fed up with those chewy yet tasteless pizzas from your local pizza shop? Order from
   ...
   What other pizza store can offer you service like this?<br />
   <br clear="all" />
   <img align="left" hspace="5" src="images/slice.gif" vspace="5" />We don't do Greek
   ...
   midnight - what could be more ideal?<br />
   <br clear="all" />
   <span style="font-size: 0.65em">1: Free except for a $10.00 charge for faxing your
      order<br />
